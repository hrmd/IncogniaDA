...
tb_pivot <- tidyr::pivot_longer(dplyr::select
                         (dplyr::select_if
                           (tb,is.numeric),-c("account_id", "device","wday")),
...
weekday <- c("Domingo","Domingo","Domingo")
...
new_events$root_permissions <- factor(new_events$root_permissions, levels = levels(data_training_bal$root_permissions))
